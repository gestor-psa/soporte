...
Característica: Actualizar Ticket
  ...
  Esquema del escenario: Actualizar ticket
    ...
    Cuando modifico el ticket "<caso>":
      | nombre   | descripcion   | responsable   | tipo   | criticidad   | estado   |
      | <nombre> | <descripcion> | <responsable> | <tipo> | <criticidad> | <estado> |
    Entonces veo que la operación fue "<resultado>"

    Ejemplos:
      | caso             | resultado | nombre                 | descripcion                  | responsable | tipo     | criticidad | estado    |
      ...
      | sin criticidad   | fallida   | Consulta sobre pedidos | ¿Cuál es el costo del envío? | Juan Perez  | consulta |            | pendiente |
  ...
  Esquema del escenario: Actualización exitosa
    ...
    Cuando modifico el ticket "<caso>":
      | nombre   | descripcion   | responsable   | tipo   | criticidad   | estado   |
      | <nombre> | <descripción> | <responsable> | <tipo> | <criticidad> | <estado> |
    Entonces veo que posee los siguientes atributos:
      | nombre   | descripcion   | responsable   | tipo   | criticidad   | estado   | fechaDeCreacion     | fechaDeActualizacion | producto | versionDelProducto |
      | <nombre> | <descripcion> | <responsable> | <tipo> | <criticidad> | <estado> | 2020/06/20 13:53:45 | del momento          | PSA ERP  | 2                  |
    ...
    Ejemplos:
      | caso                     | nombre                  | descripcion                                               | responsable | tipo       | criticidad | estado    |
      ...
      | cambiando el criticidad  | Consulta sobre pedidos  | ¿Cuál es el costo del envío?                              | Juan Perez  | consulta   | alta       | pendiente |
